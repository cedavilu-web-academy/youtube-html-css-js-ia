<h1>Código HTML5 - CSS3 y JavaScript de un programa de aumento de sueldo de los trabajadores de una Empresa</h1>
<h2>Creado solo con la Inteligencia Artificial Generativa - CHATGPT</h2>
<br>
